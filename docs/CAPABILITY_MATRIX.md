...
Pinned Hermes, OpenClaw, and DSH P1 plus Hermes-to-OpenClaw P2 are backed by
real CLI evidence in `docs/evidence/`. The first trained-agent experiment remains an
